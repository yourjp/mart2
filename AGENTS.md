...
- 사용자가 **"배포"** 또는 **"배포해줘"**, **"배포 진행"** 등의 명시적인 요청을 한 경우에만 **GitHub 저장소(`https://github.com/yourjp/mart.git`)에 최신 소스 코드를 스테이징(`git add .`), 커밋(`git commit`), 푸시(`git push -u origin main`)하는 과정**을 수행한다.
